...
/// <summary>
/// Drag a Rigidbody2D by selecting one of it s colliders by pressing the mouse down.
...
public class DragTarget : MonoBehaviour
{
	...
	{
		if(Clickcount.scoreAmount > PlayerPrefs.GetInt("HighScore", 0))
		{
			PlayerPrefs.SetInt("HighScore", Clickcount.scoreAmount);
			UpdateHighScoreText();
		}
	}
